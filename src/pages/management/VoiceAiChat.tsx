...
export default function VoiceAiChat() {
  ...
  const handleCreateThread = async () => {
    try {
      const thread = await createThread('Voice AI Chat')
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-muted-foreground">
          Chat with your voice AI assistant
        </p>
      </div>
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Choose a thread from the left or start a new voice AI chat.
                </p>
              </div>
            </div>
          ) : (
              ...
              <div className="border-t p-4">
                <div className="flex gap-2">
                  <Input
                    ...
                    placeholder="Type a message about voice AI..."
                    disabled={sending}
                    className="flex-1"
                  />
                  <Button
