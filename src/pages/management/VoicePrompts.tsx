...
export default function VoicePrompts() {
  ...
  const { grouped, loading, updatePrompt } = usePrompts('voice')
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Manage voice prompts for your AI agents
          </p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <h3 className="mt-4 text-lg font-semibold">No voice prompts found</h3>
      ...
      <Dialog open={editDialogOpen} onOpenChange={setEditDialogOpen}>
        <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-5xl">
          <DialogHeader>
            <DialogTitle>Edit Voice Prompt</DialogTitle>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="edit-prompt-name"
                  placeholder="e.g. Main Voice Agent"
                  value={formName}
